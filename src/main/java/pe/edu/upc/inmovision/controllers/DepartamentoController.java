...
public class DepartamentoController {
    ...
    @GetMapping("/listar-departamentos/{name}")
    public ResponseEntity<?> listardeppornombre(@PathVariable("name") String name)
    {
        List<Departamento> lista=dS.listarpornombre(name);

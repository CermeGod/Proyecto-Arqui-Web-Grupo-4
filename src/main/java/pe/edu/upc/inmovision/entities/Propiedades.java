...
public class Propiedades {
    ...
    public Propiedades(int propiedadId, String titulo, String descripcion, Double precio, String direccion, LocalDate fecha, Boolean estado, Double area, int habitacion, int banios, String urlVR, Distrito distrito, Usuario usuario) {
